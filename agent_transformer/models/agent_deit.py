...
@register_model
def agent_deit_tiny(pretrained=False, **kwargs):
...
@register_model
def agent_deit_small(pretrained=False, **kwargs):
...
@register_model
def agent_deit_base(pretrained=False, **kwargs):
    """ DeiT base model @ 224x224 from paper (https://arxiv.org/abs/2012.12877).
    ImageNet-1k weights from https://github.com/facebookresearch/deit.
    """
    model_kwargs = dict(patch_size=16, embed_dim=768, depth=12, num_heads=12, agent_layer=4, **kwargs)
